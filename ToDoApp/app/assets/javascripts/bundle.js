...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = __webpack_require__(169);
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(TodoList, null), document.getElementById('todo_list'));
	});
...
/***/ function(module, exports) {
	...
	var TodoStore = {
	  ...
	  addChangedHandler: function addChangedHandler(callback) {
	  ...
	  destroy: function destroy(id) {
	    var index = void 0;
	    if (_todos.some(function (todo, idx) {
	      index = idx;
	      return todo.id === id;
	    })) {
	      $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoForm = __webpack_require__(171);
	...
	var TodoList = React.createClass({
	  ...
	  todosChanged: function todosChanged() {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.state.todos.map(function (todo) {
	        return React.createElement(TodoListItem, { key: todo.id, item: todo });
	      }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var TodoStore = __webpack_require__(1);
	var DoneButton = __webpack_require__(172);
	var TodoDetailView = __webpack_require__(173);
	...
	var TodoListItem = React.createClass({
	  ...
	  renderDetail: function renderDetail() {
	    if (this.state.detail) {
	      return React.createElement(TodoDetailView, { item: this.props.item });
	    }
	  },
