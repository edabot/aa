...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoComplete = __webpack_require__(172);
	
	var Widgets = React.createClass({
	  displayName: 'Widgets',
	  getInitialState: function getInitialState() {
	    return { tabItems: [{ title: "Home", content: "HomeContent" }, { title: "Inbox", content: "InboxContent" }, { title: "About", content: "AboutContent" }, { title: "Notifications", content: "NotificationsContent" }], names: ["Jack", "Jill", "Joseph", "Johanna", "Anna", "Paul", "Phil", "Mark", "John", "Jehosephat", "Jehovah", "Jesus", "Luke"] };
	  },
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Tabs, { tabItems: this.state.tabItems }),
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Widgets, null), document.getElementById('widgets'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
	  ...
	  render: function render() {
	    var self = this;
	    var tabTitles = this.props.tabItems.map(function (tabItem, index) {
	      return React.createElement(
	        'h1',
	        { onClick: self.selectTab.bind(self, index),
	          key: tabItem.title },
	        tabItem.title
	      );
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  getWeather: function getWeather() {
	    ...
	    var latLong = "lat=" + this.state.location.latitude + "&lon=" + this.state.location.longitude;
	    var key = "645c5d39c7603f17e23fcaffcea1a3c1";
	    var baseUri = "http://api.openweathermap.org/data/2.5/weather?";
	    var uri = baseUri + latLong + "&appid=" + key;
	  ...
	  componentWillUnmount: function componentWillUnmount() {},
	  render: function render() {
	    var location = this.state.location.longitude + " " + this.state.location.latitude;
	    var weatherInfo = "loading";
	    if (this.state.weather !== "") {
	      weatherInfo = React.createElement(
	        "div",
	        null,
	        "Weather for ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoComplete = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var namesToDisplay = this.props.names;
	    ...
	    namesToDisplay = namesToDisplay.map(function (name, index) {
	      return React.createElement(
	        'li',
	        { onClick: this.handleClick, key: name },
	        name
	      );
	    }.bind(this));
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { value: this.state.searchString,
